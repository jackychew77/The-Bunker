...
public class speedScript : MonoBehaviour {
    ...
    Animator anim;
    public Transform speedMob;
    public GameObject speedAtk;
    private float hp = 40, fireRate = 0.9f, cooldown, atkRange = 1.5f, detectionRange = 500.0f, corpseTimer = 5.0f;      //default detect 15.0f
    private bool alive;
    ...
    public void meleeAtk()
    {
        if (cooldown == fireRate)
        {
            ...
            GameObject clone = Instantiate(speedAtk, speedMob.position, speedMob.rotation);
